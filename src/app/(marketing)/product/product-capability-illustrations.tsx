...
export function Illustration01() {
  ...
  return (
    <div ref={containerRef} aria-hidden="true" className="relative h-20 w-full overflow-hidden">
      <svg
...
export function Illustration05() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-20 overflow-hidden">
      <svg
        viewBox="0 0 200 80"
        fill="none"
        preserveAspectRatio="xMidYMid slice"
