    ...
    <div className="grid grid-cols-2 grid-rows-2 gap-0 bg-transparent h-full w-full">
      {personas.map((persona) => (
        <button
          ...
          className={`grid h-full w-full grid-rows-[1fr_auto] cursor-pointer  text-center shadow-sm transition-[box-shadow,border-color,background-color] duration-150 ease-out hover:shadow-md hover:border-(--primary) hover:bg-[oklch(0.95_0.01_247.84)] dark:hover:bg-[oklch(0.2686_0_0)] ${
